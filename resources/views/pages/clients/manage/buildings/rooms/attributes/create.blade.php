...
@section('breadcrumbs')
    ...
    <li class="active">Add Room Attribute</li>
@stop
@section('content')
    <div class="panel">
        ...
        <div class="panel-body">
            {!! Form::open(['route' => ['clients.manage.buildings.rooms.attributes.store', $client->slug, $building->id, $room->id], 'class' => 'form form-horizontal']) !!}

            @include('pages.clients.manage.buildings.rooms.attributes.form')

            {!! Form::submit('Create Room Attribute', ['class' => 'btn btn-info pull-right']) !!}
