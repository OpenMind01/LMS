...
@section('containerClasses', 'aside-in aside-right aside-bright aside-fixed')
            ...
            <div class="tab-content">
                ...
                <div id="topic-" class="">
                    <div class="row mode-toggler mode-bottom">
                        <div class="col-sm-9">
                            <div id="lesson-body" class="panel-body body-editable" data-id="body" style="font-size: 16px; color: rgb(60,60,60);">
...
@section('aside')
    @include('pages.clients.manage.lesson-styles.partials.aside');
@stop
...
@section('inline-scripts')
  ...
  <script>
    var elems = Array.prototype.slice.call(document.querySelectorAll('.sw'));
