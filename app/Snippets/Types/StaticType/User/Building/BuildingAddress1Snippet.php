...
class BuildingAddress1Snippet extends Snippet implements SnippetInterface
{
    ...
    public $shortCode = 'user.building.address';
    public $description = 'The street address of the user\'s building.';
    public $requiredKeys = [];
    ...
    public function getValue()
    {
        if ($this->instance->room && $this->instance->room->building)
            return $this->instance->room->building->address_1;
