...
class BuildingNumberSnippet extends Snippet implements SnippetInterface
{
    ...
    public $shortCode = 'user.building.number';
    public $description = 'The number of the user\'s building.';
    public $requiredKeys = [];
    ...
    public function getValue()
    {
        if ($this->instance->room && $this->instance->room->building)
            return $this->instance->room->building->number;
